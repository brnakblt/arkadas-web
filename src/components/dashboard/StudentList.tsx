            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left text-sm text-slate-600">
                       ...
                       ${student.status === StudentStatus.ACTIVE ? 'bg-green-100 text-green-700' : 'bg-amber-100 text-amber-700'}
                     `}>
                                            <span className={`w-1.5 h-1.5 rounded-full ${student.status === StudentStatus.ACTIVE ? 'bg-green-600' : 'bg-amber-600'}`}></span>
                                            {student.status}
                                        </span>
                                    </td>
